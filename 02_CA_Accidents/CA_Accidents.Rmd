...
```{r}
#TODO adapt this for Kaggle later
...
# col_vict$victim_safety_equipment_1 <- recode(
#     col_vict$victim_safety_equipment_1,
#     A = "None in Vehicle",
#     B = "Unknown",
#     C = "Lap Belt Used",
#     D = "Lap Belt Not Used",
...
final_res %>% collect_predictions() %>%
    ...
    # ggplot(aes(x = pred, y = 1, fill = victim_degree_of_injury)) +
